...
for strain in f1:
	...
	step1="/home/zty/sickle-master/sickle pe -t sanger -f "+strain+"_1.fastq.gz -r "+strain+"_2.fastq.gz -o "+strain+"_1.fastq -p "+strain+"_2.fastq -s "+strain+"_s.fastq"+"\n"
	step2="/home/zty/bowtie2-2.2.9/bowtie2 -x /home/zcd/script/tb_h37rv.fasta -1 "+strain+"_1.fastq -2 "+strain+"_2.fastq -U "+strain+"_s.fastq -S "+strain+".sam"+"\n"
	step3="samtools view -bhSt /home/edwin/template/bwa/tb_h37rv.fasta.fai "+strain+".sam -o "+strain+".paired.bam"+"\n"
	...
	step5=("depth=$( samtools depth "+ strain+".sort.bam | awk '{s+=$3}END{print s/NR}' )"+"\n"
		...
		"\t"+"samtools mpileup -q 30 -Q 30 -Bf /home/zcd/script/tb_h37rv.fasta "+strain+".sort.bam > "+strain+".pileup"+"\n"
		...
		"\t"+"rm "+strain+".sam "+strain+".varscan "+strain+".paired.bam "+strain+"_s.fastq "+strain+"_1.fastq "+strain+"_2.fastq "+strain+".var.for "+strain+".var.ppe "+strain+".pileup"+"\n"
		"else"+"\n"
		"\t"+"echo "+strain+" do not meet criteria: $depth"+"\t"+"$covergae >> discard"+"\n"
		"\t"+"rm "+strain+".sam "+strain+".varscan "+strain+".paired.bam "+strain+"_s.fastq "+strain+"_1.fastq "+strain+"_2.fastq "+strain+".var.for "+strain+".var.ppe "+strain+".pileup"+"\n"
		"fi"+"\n"
		)
